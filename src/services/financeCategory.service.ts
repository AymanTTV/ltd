// src/services/financeCategory.service.ts
// --------------------------------------
// Same CRUD‐shape as your existing category.service.ts, but targeting 'financeCategories'
